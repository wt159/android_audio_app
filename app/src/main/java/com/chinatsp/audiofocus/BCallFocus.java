...
public class BCallFocus extends FocusHandler {
    static private final String TAG = LogUtils.TAG + BCallFocus.class.getSimpleName() + " : ";
    ...
    public BCallFocus(Context context, AudioManager audioManager) {
        super(audioManager);
