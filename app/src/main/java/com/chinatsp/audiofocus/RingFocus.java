...
public class RingFocus extends FocusHandler {
    static private final String TAG = LogUtils.TAG + RingFocus.class.getSimpleName() + " : ";
    ...
    public RingFocus(Context context, AudioManager audioManager) {
        super(audioManager);
