...
public class CallFocus extends FocusHandler {
    static private final String TAG = LogUtils.TAG + CallFocus.class.getSimpleName() + " : ";
    ...
    public CallFocus(Context context, AudioManager audioManager) {
        super(audioManager);
