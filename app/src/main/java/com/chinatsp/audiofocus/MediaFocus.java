...
public class MediaFocus extends FocusHandler {
    static private final String TAG = LogUtils.TAG + MediaFocus.class.getSimpleName() + " : ";
    ...
    public MediaFocus(Context context, AudioManager audioManager) {
        super(audioManager);
